# Windows 작업 스케줄러 — 매일 오전 09:15 (KST) 뉴스 수집·배포·알림
...
| 설명 | `매일 09:15 KST 바이오 뉴스 크롤·push·알림` |
...
> PC 시간대가 **(UTC+09:00) 서울** 이면 09:15 = KST 09:15 입니다.
...
09:15에 **절전/꺼짐** 이면 실행되지 않습니다.  
09:15 전후 PC가 켜져 있거나, 절전 해제 타이머를 켜 두세요.
...
| 09:15에 안 돌아감 | PC 절전, 작업 비밀번호 만료, 트리거 시간 |
...
*문서 버전: Windows 09:15 KST + git push + ntfy*
